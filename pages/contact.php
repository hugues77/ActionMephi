        ...
        <div class="row">
            ...
            <div class="col-md-7">
                <form action="" method="POST">
                    ...
                    <textarea name="message" id="" cols="77" rows="3" placeholder="votre message"></textarea>
                    <button type="submit" class="form-control btn btn-outline-info" name="btn_contact">Envoyer</button>
                </form>
            </div>
        </div>
